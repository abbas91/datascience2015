...
#                                #
#                                #
#   Web Application for Python   #  
#                                #
#                                #
##################################

# ------------- Web Application for Python
from flask import Flask # web application framework building

from spyre import server # web application framework building

from ipywidgets import widgets # Interactive dashboard in ipython notebook
...
# http://dataspyre.readthedocs.io/en/latest/getting_started.html#example-1-simple-example
